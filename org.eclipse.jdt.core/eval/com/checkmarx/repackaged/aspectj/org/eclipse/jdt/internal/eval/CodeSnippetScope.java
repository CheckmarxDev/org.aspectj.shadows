 ...
 * @param kind int
 * @param parent com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Scope
 */
...
/**
 * CodeSnippetScope constructor comment.
 * @param parent com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.BlockScope
 */
...
public FieldBinding findFieldForCodeSnippet(TypeBinding receiverType, char[] fieldName, InvocationSite invocationSite) {
	...
	if (interfacesToVisit != null) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.SimpleSet interfacesSeen = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.SimpleSet(lastPosition * 2);
