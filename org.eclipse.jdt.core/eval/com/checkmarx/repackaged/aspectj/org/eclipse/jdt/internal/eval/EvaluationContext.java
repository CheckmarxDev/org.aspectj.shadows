 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.ISelectionRequestor;
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext
 */
...
public EvaluationContext() {
	...
	this.lineSeparator = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.LINE_SEPARATOR; // default value
}
/**
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext
 * @exception com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.InstallException if the code snippet class files could not be deployed.
 */
...
writer.write(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.EvaluationContext.getCodeSnippetSource());
writer.close();
com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.batch.Main.compile(
	"d:/temp/CodeSnippet.java -d d:/temp -classpath d:/jdk1.2.2/jre/lib/rt.jar -verbose");
java.io.FileInputStream reader =  new java.io.FileInputStream("d:/temp/com.checkmarx.repackaged.aspectj.org.eclipse.jdt/internal/eval/target/CodeSnippet.class");
byte[] bytes = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.Util.readContentsAsBytes(reader);
reader.close();
...
public static String getCodeSnippetSource() {
	return
		"package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.target;\n" + //$NON-NLS-1$
		"\n" + //$NON-NLS-1$
		"/*\n" + //$NON-NLS-1$
...
/**
 * Return the binary for the root code snippet class (i.e. com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.target.CodeSnippet).
 */
 ...
 *
 *  @param environment com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.SearchableEnvironment
 *      used to resolve type/package references and search for types/packages
 *      based on partial names.
 *
