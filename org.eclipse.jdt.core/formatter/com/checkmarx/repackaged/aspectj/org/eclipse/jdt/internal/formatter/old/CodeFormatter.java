 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.formatter.old;
...
public class CodeFormatter implements TerminalTokens, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICodeFormatter {
	...
	public String format(String string, int indentLevel, int[] positions, String lineSeparator) {
		...
		TextEdit textEdit = defaultCodeFormatter.format(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.formatter.CodeFormatter.K_UNKNOWN, string, 0, string.length(), indentLevel, lineSeparator);
		...
		return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.editedString(string, textEdit);
	}
}
