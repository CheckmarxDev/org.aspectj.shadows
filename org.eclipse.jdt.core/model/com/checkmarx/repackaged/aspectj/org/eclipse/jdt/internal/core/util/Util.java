...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.*;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ArrayType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ParameterizedType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.PrimitiveType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.QualifiedType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.SimpleType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.Type;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.WildcardType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IClassFileAttribute;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IClassFileReader;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.ICodeAttribute;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IFieldInfo;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IMethodInfo;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ClassSignature;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.EnumConstantSignature;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.IBinaryAnnotation;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.IDependent;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.Annotation;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.Member;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.MemberValuePair;
...
public class Util {
	...
	public static boolean equalArraysOrNull(Object[] a, Object[] b) {
		...
		// where the first part is always the same (e.g. com.checkmarx.repackaged.aspectj.org.eclipse.jdt)
	...
	private static IFile findFirstClassFile(IFolder folder) {
		try {
			...
			for (int i = 0, max = members.length; i < max; i++) {
				...
				} else if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(member.getName())) {
					return (IFile) member;
				}
			}
				...
				try {
					...
					if (path != null) {
						...
						for (Enumeration e= jar.entries(); e.hasMoreElements();) {
							...
							if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(entryName)) {
	...
	public static String getLineSeparator(String text, IJavaProject project) {
		...
		return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.LINE_SEPARATOR;
	}
				...
				case ARGUMENTS_DELIMITER :
					...
					if (next == ARGUMENTS_DELIMITER) {
						...
						if (EMPTY_ARGUMENT.equals(currentArgumentContents)) {
							currentArgumentContents = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING;
						}
	...
	public static byte[] getResourceContentsAsByteArray(IFile file) throws JavaModelException {
		...
		try {
			return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsByteArray(stream, -1);
		} catch (IOException e) {
	...
	public static char[] getResourceContentsAsCharArray(IFile file, String encoding) throws JavaModelException {
		...
		try {
			return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsCharArray(stream, (int) length, encoding);
		} catch (IOException e) {
			throw new JavaModelException(e, IJavaModelStatusConstants.IO_EXCEPTION);
		} finally {
			try {
	...
	public static JavaElement getUnresolvedJavaElement(MethodBinding methodBinding, WorkingCopyOwner workingCopyOwner, BindingsToNodesMap bindingsToNodes) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = bindingsToNodes == null ? null : bindingsToNodes.get(methodBinding);
		if (node != null && !declaringType.isBinary()) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding original = methodBinding.original();
	...
	public static JavaElement getUnresolvedJavaElement(TypeBinding typeBinding, WorkingCopyOwner workingCopyOwner, BindingsToNodesMap bindingsToNodes) {
		...
		switch (typeBinding.kind()) {
			case Binding.ARRAY_TYPE :
				typeBinding = ((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ArrayBinding) typeBinding).leafComponentType();
		...
		if (referenceBinding.isLocalType() || referenceBinding.isAnonymousType()) {
			...
			if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(fileName)) {
				int jarSeparator = CharOperation.indexOf(IDependent.JAR_FILE_ENTRY_SEPARATOR, fileName);
				int pkgEnd = CharOperation.lastIndexOf('/', fileName); // pkgEnd is exclusive
				if (pkgEnd == -1)
					pkgEnd = CharOperation.lastIndexOf(File.separatorChar, fileName);
			...
			try {
				int sourceStart = ((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) referenceBinding).sourceStart;
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding declaringElement = ((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding) referenceBinding).declaringElement;
	...
	public final static boolean isExcluded(IPath resourcePath, char[][] inclusionPatterns, char[][] exclusionPatterns, boolean isFolderPath) {
		...
		return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isExcluded(resourcePath.toString().toCharArray(), inclusionPatterns, exclusionPatterns, isFolderPath);
	}
	...
	public static int scanTypeSignature(char[] string, int start) {
		...
		return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.scanTypeSignature(string, start);
	}
	/**
	...
	static void appendTypeSignature(char[] string, int start, StringBuffer buffer, boolean compact) {
		...
		switch (c) {
			...
			case Signature.C_TYPE_VARIABLE :
				int e = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.scanTypeVariableSignature(string, start);
	...
	public static String typeSignature(TypeReference type) {
		...
		if ((type.bits & com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode.IsUnionType) != 0) {
	...
	public static IAnnotation getAnnotation(JavaElement parent, IBinaryAnnotation binaryAnnotation, String memberValuePairName) {
		char[] typeName = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.Signature.toCharArray(CharOperation.replaceOnCopy(binaryAnnotation.getTypeName(), '/', '.'));
