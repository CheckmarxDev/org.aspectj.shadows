 ...
 * for each referenced container (through the extension point "com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ClasspathContainerInitializer").
 * <p>
 * @see IClasspathEntry
 * @since 2.0
 */
...
public interface IClasspathContainer {
	 ...
	 * registered on the extension point "com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.classpathContainerInitializer", which can
