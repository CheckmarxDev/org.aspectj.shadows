...
public class LocalVariable extends SourceRefElement implements ILocalVariable {
	...
	public LocalVariable(
			...
			int nameEnd,
			String typeSignature,
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations,
			int flags,
			boolean isParameter) {
	...
	public LocalVariable(
			...
			int flags,
			boolean isParameter,
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation[][] astAnnotationsOnDimensions) {
	...
	private IAnnotation[] getAnnotations(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation[] astAnnotations) {
		int length;
	...
	private IAnnotation getAnnotation(final com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation annotation, JavaElement parentElement) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.MemberValuePair[] astMemberValuePairs = annotation.memberValuePairs();
		int length;
		IMemberValuePair[] memberValuePairs;
		if (astMemberValuePairs == null || (length = astMemberValuePairs.length) == 0) {
			...
			for (int i = 0; i < length; i++) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.MemberValuePair astMemberValuePair = astMemberValuePairs[i];
	...
	private Object getAnnotationMemberValue(MemberValuePair memberValuePair, Expression expression, JavaElement parentElement) {
		if (expression instanceof NullLiteral) {
			...
			return getAnnotation((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation) expression, parentElement);
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding#computeUniqueKey()
	 */
