...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IRuntimeVisibleTypeAnnotationsAttribute;
...
public class RuntimeVisibleTypeAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IRuntimeVisibleTypeAnnotationsAttribute.getExtendedAnnotations()
	 */
	public IExtendedAnnotation[] getExtendedAnnotations() {
		return this.extendedAnnotations;
	}
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IRuntimeVisibleTypeAnnotationsAttribute.getExtendedAnnotationsNumber()
	 */
