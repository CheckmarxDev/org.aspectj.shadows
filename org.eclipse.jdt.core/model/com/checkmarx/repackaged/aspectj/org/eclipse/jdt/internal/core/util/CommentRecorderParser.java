...
public class CommentRecorderParser extends Parser {
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeAnnotationTypeDeclarationHeader()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeClassHeader()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeEmptyTypeDeclaration()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeEnterAnonymousClassBody(boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeEnumHeader()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeInterfaceHeader()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#endParse(int)
	 */
	 ...
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#flushCommentsDefinedPriorTo(int)
	 */
	public int flushCommentsDefinedPriorTo(int position) {
		...
		if (validCount > 0){
			...
			while (index<lastCommentIndex && (immediateCommentEnd = -this.scanner.commentStops[index+1])  > 0){ // only tolerating non-javadoc comments (non-javadoc comment end positions are negative)
				...
				if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getLineNumber(position, this.scanner.lineEnds, 0, this.scanner.linePtr)
						!= com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getLineNumber(immediateCommentEnd, this.scanner.lineEnds, 0, this.scanner.linePtr)) break;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#initialize()
	 */
	 ...
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#initializeScanner()
	 */
	 ...
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#resetModifiers()
	 */
	 ...
	 * @see org.aspectj.com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.Parser#consumeToken(int)
	 */
