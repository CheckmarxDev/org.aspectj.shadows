...
public void acceptLocalVariable(LocalVariableBinding binding, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit unit) {
...
protected IJavaElement findLocalElement(int pos, MethodScope scope) {
	if (scope != null && scope.isLambdaScope()) {
		...
		if (expression != null && expression.resolvedType != null && expression.resolvedType.isValidBinding()) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.LambdaExpression lambdaElement = LambdaFactory.createLambdaExpression((JavaElement) parent, expression);
