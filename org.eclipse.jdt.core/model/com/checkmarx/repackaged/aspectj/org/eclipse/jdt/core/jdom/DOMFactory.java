 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.jdom;

import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.jdom.*;
...
public DOMFactory() {
	...
	this.lineSeparator = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.getLineSeparator(null, null/*take the workspace line separator as no project is available*/);
}
/* (non-Javadoc)
