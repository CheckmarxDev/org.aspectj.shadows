...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.TypeConverter;
...
public class BinaryTypeConverter extends TypeConverter {
	...
	private AbstractMethodDeclaration convert(IMethod method, IType type) throws JavaModelException {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter[] typeParams = null;
		...
		if (this.has1_5Compliance) {
			...
			if (typeParameters != null && typeParameters.length > 0) {
				...
				typeParams = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter[parameterCount];
	...
	private TypeDeclaration convert(IType type, IType alreadyComputedMember,TypeDeclaration alreadyComputedMemberDeclaration) throws JavaModelException {
		...
		if (this.has1_5Compliance) {
			...
			if (typeParameters != null && typeParameters.length > 0) {
				int parameterCount = typeParameters.length;
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter[] typeParams = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter[parameterCount];
				for (int i = 0; i < parameterCount; i++) {
					ITypeParameter typeParameter = typeParameters[i];
					typeParams[i] =
						createTypeParameter(
