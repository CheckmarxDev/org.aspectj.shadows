		...
		switch (element.getElementType()) {
			...
			case IJavaElement.TYPE :
				if (isRenamingMainType(element, dest)) {
					...
					String lineSeparator = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
			...
			case IJavaElement.FIELD :
				...
				lineSeparator = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
...
protected boolean isRenamingMainType(IJavaElement element, IJavaElement dest) throws JavaModelException {
	if ((isRename() || getNewNameFor(element) != null)
		...
		typeName = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.getNameWithoutJavaLikeExtension(typeName);
