...
protected String generateSyntaxIncorrectAST() {
	...
	IType type = getType();
	String lineSeparator = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.getLineSeparator(this.source, type == null ? null : type.getJavaProject());
