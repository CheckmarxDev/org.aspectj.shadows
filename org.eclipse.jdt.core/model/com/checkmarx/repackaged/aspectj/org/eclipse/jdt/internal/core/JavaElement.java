...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ISourceReference;
...
//	private static final QualifiedName PROJECT_JAVADOC= new QualifiedName(JavaCore.PLUGIN_ID, "project_javadoc_location"); //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IJavaElement#getSchedulingRule()
	 */
	...
	protected String getURLContents(URL baseLoc, String docUrlValue) throws JavaModelException {
		...
		try {
			...
			byte[] contents = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsByteArray(stream, connection.getContentLength());
			if (encoding == null) {
				...
				if (index != -1) {
					...
					if (end != -1) {
						...
						if (charsetIndex != -1) {
							...
							encoding = new String(contents, charsetIndex, end - charsetIndex, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.UTF_8);
						}
					}
				}
			}
