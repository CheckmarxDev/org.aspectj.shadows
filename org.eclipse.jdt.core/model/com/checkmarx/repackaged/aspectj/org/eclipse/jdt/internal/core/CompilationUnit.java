...
public class CompilationUnit extends Openable implements ICompilationUnit, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit, SuffixConstants {
	/**
...
protected boolean buildStructure(OpenableElementInfo info, final IProgressMonitor pm, Map newElements, IResource underlyingResource) throws JavaModelException {
	...
	try {
		...
		if (createAST) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit cu = AST.convertCompilationUnit(astLevel, compilationUnitDeclaration, options, computeProblems, source, reconcileFlags, pm);
...
public void codeComplete(int offset, ICompletionRequestor requestor, WorkingCopyOwner workingCopyOwner) throws JavaModelException {
	...
	codeComplete(offset, new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), workingCopyOwner);
}
/**
...
/* (non-Javadoc)
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.CompletionRequestor)
 */
public void codeComplete(int offset, CompletionRequestor requestor) throws JavaModelException {
	codeComplete(offset, requestor, DefaultWorkingCopyOwner.PRIMARY);
}
/* (non-Javadoc)
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.CompletionRequestor, org.eclipse.core.runtime.IProgressMonitor)
 */
...
/* (non-Javadoc)
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.CompletionRequestor, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.WorkingCopyOwner)
 */
...
/* (non-Javadoc)
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICodeAssist#codeComplete(int, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.CompletionRequestor, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.WorkingCopyOwner, org.eclipse.core.runtime.IProgressMonitor)
 */
public void codeComplete(int offset, CompletionRequestor requestor, WorkingCopyOwner workingCopyOwner, IProgressMonitor monitor) throws JavaModelException {
	codeComplete(
			this,
			isWorkingCopy() ? (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) getOriginalElement() : this,
			offset,
			requestor,
			workingCopyOwner,
			this,
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit#getContents()
 */
public char[] getContents() {
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.IDependent#getFileName()
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit#getMainTypeName()
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit#getPackageName()
 */
...
public com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit makeConsistent(int astLevel, boolean resolveBindings, int reconcileFlags, HashMap problems, IProgressMonitor monitor) throws JavaModelException {
	...
	try {
		...
		if (astLevel != NO_AST || problems != null) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit result = info.ast;
			info.ast = null;
			return result;
		} else {
 ...
 * @since 3.0
 */
public com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit reconcile(
		int astLevel,
