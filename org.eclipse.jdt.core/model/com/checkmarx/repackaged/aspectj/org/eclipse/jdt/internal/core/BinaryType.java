...
public class BinaryType extends BinaryMember implements IType, SuffixConstants {
	...
	public static final JavadocContents EMPTY_JAVADOC = new JavadocContents(null, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING);
...
public void codeComplete(char[] snippet,int insertion,int position,char[][] localVariableTypeNames,char[][] localVariableNames,int[] localVariableModifiers,boolean isStatic,ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(snippet, insertion, position, localVariableTypeNames, localVariableNames, localVariableModifiers, isStatic, new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
/*
 * @see IType#codeComplete(char[], int, int, char[][], char[][], int[], boolean, ICompletionRequestor)
 */
...
public String getSuperclassTypeSignature() throws JavaModelException {
	...
	if (genericSignature != null) {
		...
		int start = index;
		index = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.scanClassTypeSignature(genericSignature, start) + 1;
...
public String[] getSuperInterfaceTypeSignatures() throws JavaModelException {
	...
	if (genericSignature != null) {
		...
		// skip superclass
		index = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.scanClassTypeSignature(genericSignature, index) + 1;
...
/* (non-Javadoc)
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IType#isResolved()
 */
