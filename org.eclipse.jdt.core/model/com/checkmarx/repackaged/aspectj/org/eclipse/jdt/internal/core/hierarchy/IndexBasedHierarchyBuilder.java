 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.hierarchy;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchPattern;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.AccessRuleSet;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.IPathRequestor;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.nd.IReader;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.IndexQueryRequestor;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.JavaSearchParticipant;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.SubTypeSearchJob;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.UnindexedSearchScope;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.indexing.IIndexConstants;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.indexing.IndexManager;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.MatchLocator;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.SuperTypeReferencePattern;
...
private void buildForProject(JavaProject project, ArrayList potentialSubtypes, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] workingCopies, HashSet localTypes, IProgressMonitor monitor) throws JavaModelException {
	...
	if (openablesLength > 0) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside = null;
		if (inProjectOfFocusType) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType.getCompilationUnit();
			if (unitToLookInside != null) {
				int wcLength = workingCopies == null ? 0 : workingCopies.length;
				if (wcLength == 0) {
					unitsToLookInside = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] {unitToLookInside};
				} else {
					unitsToLookInside = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[wcLength+1];
...
private void buildFromPotentialSubtypes(String[] allPotentialSubTypes, HashSet localTypes, IProgressMonitor monitor) {
	...
	int wcLength;
	com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
	if (workingCopies != null && (wcLength = workingCopies.length) > 0) {
		String[] newPaths = new String[wcLength];
		for (int i = 0; i < wcLength; i++) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy = workingCopies[i];
	...
	try {
		...
		for (int i = 0; i < length; i++) {
			...
			try {
				...
				Openable handle;
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit)wcPaths.get(resourcePath);
				if (workingCopy != null) {
