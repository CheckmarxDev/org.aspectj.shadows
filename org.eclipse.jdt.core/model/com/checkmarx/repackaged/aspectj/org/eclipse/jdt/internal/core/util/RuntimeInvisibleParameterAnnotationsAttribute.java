...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IParameterAnnotation;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IRuntimeInvisibleParameterAnnotationsAttribute;
...
public class RuntimeInvisibleParameterAnnotationsAttribute
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IRuntimeInvisibleParameterAnnotations#getAnnotations()
	 */
	public IParameterAnnotation[] getParameterAnnotations() {
		return this.parameterAnnotations;
	}
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IRuntimeInvisibleParameterAnnotations#getParametersNumber()
	 */
