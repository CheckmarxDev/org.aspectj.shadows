...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.rewrite.ASTRewrite;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.rewrite.ListRewrite;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.CompilationUnitSorter;
...
public class SortElementsOperation extends JavaModelOperation {
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.JavaModelOperation#executeOperation()
	 */
	 ...
	 */
	public TextEdit calculateEdit(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit unit, TextEditGroup group) throws JavaModelException {
	...
	private String processElement(ICompilationUnit unit, char[] source) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit ast = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit) parser.createAST(null);
	...
	private ASTRewrite sortCompilationUnit(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit ast, final TextEditGroup group) {
		ast.accept(new ASTVisitor() {
			public boolean visit(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
		...
		ast.accept(new ASTVisitor() {
			...
			public boolean visit(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit compilationUnit) {
				...
				sortElements(compilationUnit.types(), rewriter.getListRewrite(compilationUnit, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.CompilationUnit.TYPES_PROPERTY));
				return true;
			}
