...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.IGenericType;
...
public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction) {
	...
	if (unit != null) {
		try {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit cu = ((SourceTypeElementInfo)sourceType).getHandle().getCompilationUnit();
 ...
 */
private void rememberAllTypes(CompilationUnitDeclaration parsedUnit, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit cu, boolean includeLocalTypes) {
...
public void resolve(IGenericType suppliedType) {
	try {
		if (suppliedType.isBinaryType()) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit cu = ((SourceTypeElementInfo)suppliedType).getHandle().getCompilationUnit();
			if (cu != null) {
...
public void resolve(Openable[] openables, HashSet localTypes, IProgressMonitor monitor) {
	...
	try {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] cus = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[openablesLength];
		int unitsIndex = 0;
		...
		for (int i = 0; i < openablesLength; i++) {
			...
			if (openable instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit cu = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit)openable;
