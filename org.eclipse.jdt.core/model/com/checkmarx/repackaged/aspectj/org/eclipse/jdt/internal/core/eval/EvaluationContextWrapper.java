 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.eval;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.ICodeSnippetRequestor;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IGlobalVariable;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.builder.NameEnvironment;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.builder.ProblemFactory;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.EvaluationContext;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.GlobalVariable;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.IRequestor;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.eval.InstallException;
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#allVariables()
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor)
 * @deprecated
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, ICompletionRequestor, WorkingCopyOwner)
 * @deprecated
 */
public void codeComplete(String codeSnippet, int position, ICompletionRequestor requestor, WorkingCopyOwner owner) throws JavaModelException {
	...
	codeComplete(codeSnippet, position, new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.CompletionRequestorWrapper(requestor), owner);
}
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor)
 */
public void codeComplete(String codeSnippet, int position, CompletionRequestor requestor) throws JavaModelException {
	codeComplete(codeSnippet, position, requestor, DefaultWorkingCopyOwner.PRIMARY);
}
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, IProgressMonitor)
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner)
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeComplete(String, int, CompletionRequestor, WorkingCopyOwner, IProgressMonitor)
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeSelect(String, int, int)
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#codeSelect(String, int, int, WorkingCopyOwner)
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#deleteVariable(IGlobalVariable)
 */
...
public void evaluateCodeSnippet(
	...
	IProgressMonitor progressMonitor) throws com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.JavaModelException {
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#getImports()
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#getPackageName()
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#getProject()
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#newVariable(String, String, String)
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#setImports(String[])
 */
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.eval.IEvaluationContext#setPackageName(String)
 */
 ...
 */
public void codeComplete(String codeSnippet, int position, final com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICodeCompletionRequestor requestor) throws JavaModelException {
