...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.ResolvedBinaryType;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.ResourceCompilationUnit;
...
public abstract class HierarchyBuilder {
	...
	public HierarchyBuilder(TypeHierarchy hierarchy) throws JavaModelException {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType == null ? null : focusType.getCompilationUnit();
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside;
...
protected IBinaryType createInfoFromClassFile(Openable handle, IResource file) {
	...
	} catch (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.classfmt.ClassFormatException e) {
		if (TypeHierarchy.DEBUG) {
			e.printStackTrace();
		}
		return null;
