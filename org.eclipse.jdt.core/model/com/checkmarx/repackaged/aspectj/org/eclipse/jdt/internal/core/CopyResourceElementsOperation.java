...
public class CopyResourceElementsOperation extends MultiOperation implements SuffixConstants {
	...
	private void processCompilationUnitResource(ICompilationUnit source, PackageFragment dest) throws JavaModelException {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnit destCU = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnit(dest, destName, DefaultWorkingCopyOwner.PRIMARY);
	...
	private void updatePackageStatement(CompilationUnit astCU, String[] pkgName, ASTRewrite rewriter, ICompilationUnit cu) throws JavaModelException {
		...
		if (defaultPackage) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.PackageDeclaration pkg = astCU.getPackage();
			if (pkg != null) {
	...
	protected void verify(IJavaElement element) throws JavaModelException {
		...
		if (elementType == IJavaElement.COMPILATION_UNIT) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnit compilationUnit = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnit) element;
