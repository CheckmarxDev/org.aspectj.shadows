...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.compiler.IScanner;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.compiler.ITerminalSymbols;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.ClassFileBytesDisassembler;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.ClassFileReader;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Disassembler;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.PublicScanner;
...
public class ToolFactory {
	 ...
	 * extension point "com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.codeFormatter". If unable to find a registered extension, the factory
	 ...
	 * point "com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.javaFormatter". The formatter id specified in the
	 * "com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.javaFormatter" is instantiated. If unable to find a registered extension, the factory will
	...
	public static CodeFormatter createCodeFormatter(Map options, int mode) {
		...
		if (formatterId != null) {
					...
					for (int j = 0; j < configElements.length; j++) {
						...
						if (initializerID != null && initializerID.equals(formatterId)) {
							try {
								...
								com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e.getStatus());
								break;
							}
						}
					}
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(IStatus.WARNING,
	 ...
	 *
	 * @return a classfile bytecode disassembler
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IClassFileDisassembler
	 * @deprecated Use {@link #createDefaultClassFileBytesDisassembler()} instead
	 */
	public static com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IClassFileDisassembler createDefaultClassFileDisassembler(){
		class DeprecatedDisassembler extends Disassembler implements com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IClassFileDisassembler {
		...
		if (root != null){
			try {
				if (root instanceof JarPackageFragmentRoot) {
					...
					String entryName = com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.concatWith(packageFragment.names, classFileName, '/');
	...
	public static ICodeFormatter createDefaultCodeFormatter(Map options){
		if (options == null) options = JavaCore.getOptions();
		return new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.formatter.old.CodeFormatter(options);
	}
	 ...
	 * considered as valid line separators.
  	 * @return a scanner
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.compiler.IScanner
