...
class BindingComparator {
	...
	static boolean isEqual(Binding declaringElement, Binding declaringElement2, HashSet visitedTypes) {
		if (declaringElement instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
			if (!(declaringElement2 instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding)){
				return false;
			}
			return isEqual((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement,
					(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement2,
					visitedTypes);
		} else if (declaringElement instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) {
			if (!(declaringElement2 instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding)) {
				return false;
			}
			return isEqual((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) declaringElement,
					(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) declaringElement2,
					visitedTypes);
		...
		} else if (declaringElement instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) {
			if (!(declaringElement2 instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding)) {
				return false;
			}
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) declaringElement;
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding2 = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) declaringElement2;
	...
	static boolean isEqual(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding,
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding2) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] bindings, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] otherBindings) {
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] bindings, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] otherBindings, HashSet visitedTypes) {
		if (bindings == null) {
			return otherBindings == null;
		}
		if (otherBindings == null) {
	...
	static boolean isEqual(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding2, HashSet visitedTypes) {
		if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.equalsEquals(typeBinding, typeBinding2))
			return true;
	 ...
	 * @return true if both parameters are equals, false otherwise
	 */
	static boolean isEqual(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding2) {
