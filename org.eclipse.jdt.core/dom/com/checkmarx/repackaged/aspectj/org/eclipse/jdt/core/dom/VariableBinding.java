...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IModifierConstants;
...
class VariableBinding implements IVariableBinding {
	...
	private com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding binding;
	...
	VariableBinding(BindingResolver resolver, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding binding) {
			...
			while (true) {
				if (node == null) {
					if (this.binding instanceof LocalVariableBinding) {
						...
						com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding enclosingMethod = localVariableBinding.getEnclosingMethod();
	...
	public boolean isEqualTo(IBinding other) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding otherBinding = ((VariableBinding) other).binding;
	...
	/*
	 * (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IVariableBinding.isEffectivelyFinal()
	 */
