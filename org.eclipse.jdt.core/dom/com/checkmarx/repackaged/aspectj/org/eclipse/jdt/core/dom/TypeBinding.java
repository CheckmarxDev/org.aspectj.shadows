...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.IntersectionTypeBinding18;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.RawTypeBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.JavaElement;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.PackageFragment;

/**
 * Internal implementation of type bindings.
 */
class TypeBinding implements ITypeBinding {
	private static final StringLiteral EXPRESSION = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.StringLiteral(0,0);
	...
	com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding;
	...
	public static TypeBinding createTypeBinding(BindingResolver resolver,
												com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding referenceBinding,
	...
	public TypeBinding(BindingResolver resolver, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding) {
		this.binding = binding;
		this.resolver = resolver;
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding compilerPrototype = binding.prototype();
	...
	public IAnnotationBinding[] getAnnotations() {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding refType = null;
		if (this.binding instanceof ParameterizedTypeBinding) {
			...
			refType = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ReferenceBinding) this.binding;
		}
		if (refType != null) {
	...
	private IAnnotationBinding[] resolveAnnotationBindings(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations, boolean isTypeUse) {
		int length = internalAnnotations == null ? 0 : internalAnnotations.length;
		if (length != 0) {
			IAnnotationBinding[] tempAnnotations = new IAnnotationBinding[length];
			int convertedAnnotationCount = 0;
			for (int i = 0; i < length; i++) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalAnnotation = internalAnnotations[i];
	...
	public String getBinaryName() {
		if (this.binding.isCapture()) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding declaring = typeVariableBinding.declaringElement;
			StringBuffer binaryName = new StringBuffer();
			switch(declaring.kind()) {
				case com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding.METHOD :
					...
					break;
				default :
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaring;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getBound()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getGenericTypeOfWildcardType()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getRank()
	 */
	public int getRank() {
		switch (this.binding.kind()) {
			case Binding.WILDCARD_TYPE :
	...
	public synchronized IVariableBinding[] getDeclaredFields() {
		...
		try {
			 ...
			 */
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared fields"); //$NON-NLS-1$
		}
		return this.fields = NO_VARIABLE_BINDINGS;
	}
	...
	public synchronized IMethodBinding[] getDeclaredMethods() {
		...
		try {
			if (isClass() || isInterface() || isEnum()) {
				ReferenceBinding referenceBinding = (ReferenceBinding) this.binding;
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding[] internalMethods = referenceBinding.availableMethods(); // be resilient
				int length = internalMethods.length;
				if (length != 0) {
					int convertedMethodCount = 0;
					IMethodBinding[] newMethods = new IMethodBinding[length];
					for (int i = 0; i < length; i++) {
						com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding = internalMethods[i];
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared methods"); //$NON-NLS-1$
		}
		return this.methods = NO_METHOD_BINDINGS;
	}
	...
	public synchronized IMethodBinding getDeclaringMethod() {
		if (this.binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding localTypeBinding = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) this.binding;
			...
			if (methodBinding != null) {
				try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring method"); //$NON-NLS-1$
				}
			}
		} else if (this.binding.isTypeVariable()) {
			TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
		...
		if (isClass() || isInterface() || isEnum()) {
			...
			if (referenceBinding.isNestedType()) {
				try {
					 ...
					 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
					 */
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring class"); //$NON-NLS-1$
				}
			}
		} else if (this.binding.isTypeVariable()) {
			TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getTypeDeclaration()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getErasure()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getFunctionalInterfaceMethod
	 */
	@Override
	...
	public synchronized ITypeBinding[] getInterfaces() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve interfaces"); //$NON-NLS-1$
		}
	...
	private JavaElement getUnresolvedJavaElement(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding ) {
		...
		if (this.resolver instanceof DefaultBindingResolver) {
			...
			return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.getUnresolvedJavaElement(
					typeBinding,
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getQualifiedName()
	 */
	...
	public synchronized ITypeBinding getSuperclass() {
		...
		try {
			 ...
			 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=64299
			 */
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve superclass"); //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getTypeArguments()
	 */
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding.isParameterizedTypeWithActualArguments()) {
			ParameterizedTypeBinding parameterizedTypeBinding = (ParameterizedTypeBinding) this.binding;
			final com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] arguments = parameterizedTypeBinding.arguments;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getTypeBounds()
	 */
	public ITypeBinding[] getTypeBounds() {
		...
		if (typeVariableBinding != null) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding firstClassOrArrayBound = typeVariableBinding.firstBound;
			int boundsLength = 0;
			if (firstClassOrArrayBound == null) {
				...
				if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.equalsEquals(firstClassOrArrayBound, varSuperclass)) {
					boundsLength++;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getTypeParameters()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#getWildcard()
	 * @since 3.1
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#isGenericType()
	 * @since 3.1
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#isAnnotation()
	 */
	...
	public boolean isCastCompatible(ITypeBinding type) {
		try {
			...
			if (scope == null) return false;
			if (!(type instanceof TypeBinding)) return false;
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding expressionType = ((TypeBinding) type).binding;
	...
	public boolean isEqualTo(IBinding other) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding otherBinding = ((TypeBinding) other).binding;
		if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.equalsEquals(otherBinding.unannotated(), this.binding.unannotated())) {
			return true;
		}
		// check return type
	...
	public boolean isFromSource() {
		if (isClass() || isInterface() || isEnum()) {
			...
			if (referenceBinding.isRawType()) {
				...
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding erasure = parameterizedTypeBinding.erasure();
			...
			if (declaringElement instanceof MethodBinding) {
				...
				final com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) declaringElement;
				if (typeBinding instanceof ReferenceBinding) {
					...
					final com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding leafComponentType = arrayBinding.leafComponentType;
	...
	public boolean isNullType() {
		return this.binding == com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.NULL;
	}

	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#isParameterizedType()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#isRawType()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#isUpperbound()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.ITypeBinding#isWildcardType()
	 */
