...
class MemberValuePairBinding implements IMemberValuePairBinding {
	...
	static Object buildDOMValue(final Object internalObject, BindingResolver resolver) {
		...
		} else if (internalObject instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
			return resolver.getTypeBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) internalObject);
		} else if (internalObject instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding) {
			return resolver.getAnnotationInstance((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding) internalObject);
		} else if (internalObject instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.FieldBinding) {
			return resolver.getVariableBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.FieldBinding) internalObject);
