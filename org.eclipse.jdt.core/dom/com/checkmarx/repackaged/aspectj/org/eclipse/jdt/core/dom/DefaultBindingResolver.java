 ...
 *								Bug 342671 - ClassCastException: com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.SourceTypeBinding cannot be cast to com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ArrayBinding
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.WorkingCopyOwner;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.AllocationExpression;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ArrayAllocationExpression;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.FieldReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ImportReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocAllocationExpression;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocFieldReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocImplicitTypeReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocMessageSend;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocQualifiedTypeReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocSingleNameReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.JavadocSingleTypeReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Literal;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.LocalDeclaration;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.MemberValuePair;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.QualifiedNameReference;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ThisReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.impl.Constant;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ArrayBinding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.BlockScope;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.CompilationUnitScope;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ElementValuePair;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.FieldBinding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LocalVariableBinding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LookupEnvironment;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodScope;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ParameterizedGenericMethodBinding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ProblemFieldBinding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ProblemReasons;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ProblemReferenceBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TagBits;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeConstants;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeIds;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VoidTypeBinding;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.AbortCompilation;
...
class DefaultBindingResolver extends BindingResolver {
	...
	IBinding getBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding binding) {
		switch (binding.kind()) {
			case Binding.PACKAGE:
				return getPackageBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) binding);
			case Binding.TYPE:
			case Binding.BASE_TYPE:
			case Binding.GENERIC_TYPE:
			case Binding.PARAMETERIZED_TYPE:
			case Binding.RAW_TYPE:
				return getTypeBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) binding);
			case Binding.ARRAY_TYPE:
			case Binding.TYPE_PARAMETER:
				return new TypeBinding(this, (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) binding);
			case Binding.METHOD:
				return getMethodBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) binding);
			case Binding.FIELD:
			case Binding.LOCAL:
				return getVariableBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding) binding);
		}
		return null;
	}
	...
	Util.BindingsToNodesMap getBindingsToNodesMap() {
		return new Util.BindingsToNodesMap() {
			public com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode get(Binding binding) {
				return (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode)
					DefaultBindingResolver.this.newAstToOldAst.get(DefaultBindingResolver.this.bindingsToAstNodes.get(binding));
			}
		};
	}

	synchronized com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode getCorrespondingNode(ASTNode currentNode) {
		return (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(currentNode);
	}

	/*
	 * Method declared on BindingResolver.
	 */
	synchronized IMethodBinding getMethodBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding) {
		return getMethodOrLambdaBinding(methodBinding, null, null);
	}

	private synchronized IMethodBinding getMethodOrLambdaBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding,
													com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding descriptor,
													IBinding enclosingBinding)
	{
 		if (methodBinding != null && !methodBinding.isValidBinding()) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding =
				(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding) methodBinding;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IPackageBinding getPackageBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding packageBinding) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized ITypeBinding getTypeBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding referenceBinding) {
		return internalGetTypeBinding(referenceBinding, null);
	}

	private synchronized ITypeBinding internalGetTypeBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding referenceBinding, IBinding declaringMember) {
			...
			switch(referenceBinding.problemId()) {
				...
				case ProblemReasons.NonStaticReferenceInStaticContext :
					if (referenceBinding instanceof ProblemReferenceBinding) {
						...
						com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding2 = problemReferenceBinding.closestMatch();
	...
	synchronized IVariableBinding getVariableBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding variableBinding, VariableDeclaration variableDeclaration) {
		if (this.isRecoveringBindings) {
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized IVariableBinding getVariableBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding variableBinding) {
		if (variableBinding != null) {
			if (variableBinding.isValidBinding()) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding variableType = variableBinding.type;
	...
	static class AnnotationIdentityBinding {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalInstance;
		AnnotationIdentityBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalInstance) {
	...
	synchronized IAnnotationBinding getAnnotationInstance(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding internalInstance) {
	...
	boolean isResolvedTypeInferredFromExpectedType(MethodInvocation methodInvocation) {
		...
		if (oldNode instanceof MessageSend) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding = messageSend.binding;
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.BindingResolver#recordScope(ASTNode, BlockScope)
	 */
	...
	boolean resolveBoxing(Expression expression) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression compilerExpression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression) node;
	...
	synchronized IMethodBinding resolveConstructor(ClassInstanceCreation expression) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
		if (node != null && (node.bits & com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.BindingResolver#resolveConstructor(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.EnumConstantDeclaration)
	 */
	IMethodBinding resolveConstructor(EnumConstantDeclaration enumConstantDeclaration) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(enumConstantDeclaration);
		if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration) {
		...
		try {
			switch(expression.getNodeType()) {
				case ASTNode.CLASS_INSTANCE_CREATION :
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode astNode = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(expression);
					if (astNode instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) {
						// anonymous type case
						com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) astNode;
				...
				case ASTNode.SINGLE_MEMBER_ANNOTATION :
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression compilerExpression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression) this.newAstToOldAst.get(expression);
	...
	synchronized IBinding resolveImport(ImportDeclaration importDeclaration) {
		...
		try {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(importDeclaration);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
				final boolean isStatic = importReference.isStatic();
				if ((importReference.bits & com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0) {
					...
					if (binding != null) {
						if (isStatic) {
							if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
								ITypeBinding typeBinding = this.getTypeBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) binding);
								return typeBinding == null ? null : typeBinding;
							}
						} else {
							if ((binding.kind() & Binding.PACKAGE) != 0) {
								IPackageBinding packageBinding = getPackageBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) binding);
								if (packageBinding == null) {
									return null;
								}
					...
					if (binding != null) {
						if (isStatic) {
							...
							} else if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) {
								// it is a type
								return getMethodBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding)binding);
							}
						} else {
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.BindingResolver#resolveMember(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.AnnotationTypeMemberDeclaration)
	 */
	...
	synchronized IMethodBinding resolveMethod(LambdaExpression lambda) {
		...
		if (oldNode instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.LambdaExpression) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.LambdaExpression lambdaExpression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.LambdaExpression) oldNode;
	...
	private IBinding getDeclaringMember(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node, Scope currentScope) {
		MethodScope methodScope = currentScope != null ? currentScope.methodScope() : null;
		if (methodScope != null) {
			if (methodScope.isInsideInitializer()) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration enclosingType = methodScope.referenceType();
				if (enclosingType.fields != null) {
					for (int i = 0; i < enclosingType.fields.length; i++) {
						...
						if (field.declarationSourceStart <= node.sourceStart && node.sourceEnd <= field.declarationSourceEnd) {
							if (field instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Initializer)
								return getMethodBinding(((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Initializer) field).getMethodBinding());
							else
				...
				if (methodScope.isLambdaScope()) {
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.LambdaExpression lambdaExpression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.LambdaExpression) methodScope.referenceContext;
					IMethodBinding methodBinding = null;
					if (lambdaExpression.descriptor != null) {
						IBinding declaringMember = getDeclaringMember(lambdaExpression, lambdaExpression.enclosingScope);
						if (declaringMember != null)
...
/*
	...
	synchronized IMethodBinding resolveMethod(MethodReference methodReference) {
		...
		if (oldNode instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ReferenceExpression) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ReferenceExpression referenceExpression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ReferenceExpression) oldNode;
	...
	synchronized ITypeBinding resolveTypeBindingForName(Name name) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(name);
		...
		if (node instanceof QualifiedNameReference) {
			...
			if (index < indexOfFirstFieldBinding) {
				...
				if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) {
					return null;
				} else if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding) {
					// it is a type
					return this.getTypeBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
				}
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding type = fieldBinding.declaringClass;
					if (type == null) { // array length scenario
						// use type from first binding (no capture needed for array type)
						switch (qualifiedNameReference.bits & com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode.RestrictiveFlagMASK) {
							case Binding.FIELD:
			...
			if (index >= 0) {
				...
				if (importReferenceLength == index) {
					try {
						binding = this.scope.getImport(CharOperation.subarray(importReference.tokens, 0, index), (importReference.bits & com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode.OnDemand) != 0, importReference.isStatic());
					} catch (AbortCompilation e) {
						// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=53357
					}
				} else {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding != null) {
				return typeBinding;
			}
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding receiver = ((Receiver) node).type.resolvedType;
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding = singleTypeReference.resolvedType;
			if (binding != null) {
		...
		} else if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter) node;
			return this.getTypeBinding(typeParameter.binding);
		} else if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.MemberValuePair) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.MemberValuePair memberValuePair = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.MemberValuePair) node;
			IMethodBinding method = getMethodBinding(memberValuePair.binding);
			if (method == null) return null;
			return method.getReturnType();
		} else if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ReferenceExpression) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ReferenceExpression referenceExpression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ReferenceExpression) node;
	...
	synchronized IBinding resolveName(Name name) {
		...
		if (node instanceof QualifiedNameReference) {
				...
				if (qualifiedNameReference.isTypeReference()) {
					...
					if (binding != null) {
						if (binding.isValidBinding()) {
							return this.getVariableBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.VariableBinding) binding);
			...
			if (index >= 0) {
				...
				if (binding != null) {
					if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PackageBinding) {
						...
						// it is a type
						return this.getTypeBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding)binding);
					} else if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.FieldBinding) {
						// it is a type
						return this.getVariableBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.FieldBinding)binding);
					} else if (binding instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding) {
						// it is a type
						return getMethodBinding((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding)binding);
					} else {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration[] types = compilationUnitDeclaration.types;
			if (types == null || types.length == 0) {
				return null;
			}
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration type = types[0];
			if (type != null) {
	...
	synchronized IPackageBinding resolvePackage(PackageDeclaration pkg) {
		if (this.scope == null) return null;
		try {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(pkg);
			if (node instanceof ImportReference) {
				ImportReference importReference = (ImportReference) node;
	...
	synchronized IBinding resolveReference(MemberRef ref) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression expression = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression) this.newAstToOldAst.get(ref);
     ...
     * @since 3.2
	 */
	synchronized IMemberValuePairBinding resolveMemberValuePair(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.MemberValuePair memberValuePair) {
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.BindingResolver#resolveType(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.AnnotationTypeDeclaration)
	 */
	ITypeBinding resolveType(AnnotationTypeDeclaration type) {
		final Object node = this.newAstToOldAst.get(type);
		if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration typeDeclaration = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
			ITypeBinding typeBinding = this.getTypeBinding(typeDeclaration.binding);
			if (typeBinding == null) {
				return null;
	...
	synchronized ITypeBinding resolveType(AnonymousClassDeclaration type) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		if (node != null && (node.bits & com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode.IsAnonymousType) != 0) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration anonymousLocalTypeDeclaration = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration) node;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.BindingResolver#resolveType(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.EnumDeclaration)
	 */
	...
	synchronized ITypeBinding resolveType(Type type) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode node = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode) this.newAstToOldAst.get(type);
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding binding = null;
		if (node != null) {
			...
			if (node instanceof ParameterizedQualifiedTypeReference) {
				...
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding = typeReference.resolvedType;
			...
			if (((PrimitiveType) type).getPrimitiveTypeCode() == PrimitiveType.VOID) {
				return this.getTypeBinding(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding.VOID);
			}
		}
		return null;
	}

	private com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] getTypeAnnotations(int dimensions, ArrayBinding arrayBinding, boolean isVarargs) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding [] oldies = arrayBinding.getTypeAnnotations();
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] newbies = Binding.NO_ANNOTATIONS;
		...
		if (cells > 0)
			System.arraycopy(oldies, i, newbies = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[cells], 0, cells);
		return newbies;
	}
	...
	synchronized ITypeBinding resolveTypeParameter(TypeParameter typeParameter) {
		...
		if (node instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter typeParameter2 = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeParameter) node;
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.BindingResolver#resolveVariable(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.EnumConstantDeclaration)
	 */
	...
	synchronized IVariableBinding resolveVariable(VariableDeclaration variable) {
		...
		if (node instanceof AbstractVariableDeclaration) {
			...
			if (abstractVariableDeclaration instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration fieldDeclaration = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.FieldDeclaration) abstractVariableDeclaration;
	...
	synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
		...
		if (oldNode instanceof com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation internalAstNode =
				(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Annotation) oldNode;
	 ...
	 * Method declared on BindingResolver.
	 */
	synchronized void store(ASTNode node, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode oldASTNode) {
	...
	ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding leafTypeBinding = 
	...
	private com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] insertAnnotations(
							com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] annots, int dimensions) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] newAnnots = 
				new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[annots.length - index + dimensions];
