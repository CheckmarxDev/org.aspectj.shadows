...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.batch.Main;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.CodeSnippetParsingUtil;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.RecordedParsingInformation;
...
public class ASTParser {
	...
	private List getClasspath() throws IllegalStateException {
		...
		try {
			if ((this.bits & CompilationUnitResolver.INCLUDE_RUNNING_VM_BOOTCLASSPATH) != 0) {
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.collectRunningVMBootclasspath(allClasspaths);
			}
	 ...
	 * </p>
	 * <p>Note that working copy owners are used only if the <code>com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core</code>
		...
		switch(this.astKind) {
				...
				if (this.rawSource == null) {
					if (this.typeRoot != null) {
						...
						if (this.typeRoot instanceof ICompilationUnit) {
							com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
			...
			case K_COMPILATION_UNIT :
				...
				try {
					...
					com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = null;
					...
					if (this.typeRoot instanceof ICompilationUnit) {
							/*
							 * this.compilationUnitSource is an instance of com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnit that implements
							 * both com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit and com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit
							 */
							sourceUnit = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
							/*
	...
	private ASTNode internalCreateASTForKind() {
		...
		switch(this.astKind) {
			case K_STATEMENTS :
				...
				if (constructorCall != null && constructorCall.accessMode != com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall.ImplicitSuper) {
					block.statements().add(converter.convert(constructorCall));
				}
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Statement[] statements = constructorDeclaration.statements;
				if (statements != null) {
				...
				return block;
			case K_EXPRESSION :
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Expression expression = codeSnippetParsingUtil.parseExpression(this.rawSource, this.sourceOffset, this.sourceLength, this.compilerOptions, true);
			...
			case K_CLASS_BODY_DECLARATIONS :
				final com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode[] nodes =
