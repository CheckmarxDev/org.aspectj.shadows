...
class MethodBinding implements IMethodBinding {
	...
	protected com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding binding;
	...
	MethodBinding(BindingResolver resolver, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding binding) {
	...
	public IAnnotationBinding[] getAnnotations() {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations = this.binding.getAnnotations();
	...
	public IAnnotationBinding[] getParameterAnnotations(int index) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[][] bindingAnnotations = this.binding.getParameterAnnotations();
		...
		for (int i = 0; i < length; i++) {
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] paramBindingAnnotations = bindingAnnotations[i];
	...
	public ITypeBinding[] getParameterTypes() {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] parameters = this.binding.parameters;
	...
	protected IAnnotationBinding[] filterTypeAnnotations(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] internalAnnotations) {
	...
	public ITypeBinding[] getExceptionTypes() {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] exceptions = this.binding.thrownExceptions;
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#isVarargs()
	 * @since 3.1
	 */
	...
	public boolean isEqualTo(IBinding other) {
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding otherBinding = ((MethodBinding) other).binding;
		return BindingComparator.isEqual(this.binding, otherBinding);
	}

	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#getTypeParameters()
	 */
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#isGenericMethod()
	 * @since 3.1
	 */
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#getTypeArguments()
	 */
	public ITypeBinding[] getTypeArguments() {
		...
		if (this.binding instanceof ParameterizedGenericMethodBinding) {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.TypeBinding[] typeArgumentsBindings = genericMethodBinding.typeArguments;
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#isParameterizedMethod()
	 */
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#isRawMethod()
	 */
	...
	/**
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.dom.IMethodBinding#getMethodDeclaration()
	 */
	...
	static class LambdaMethod extends MethodBinding {
		...
		public LambdaMethod(DefaultBindingResolver resolver,
							com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding lambdaDescriptor,
							com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding implementation,
