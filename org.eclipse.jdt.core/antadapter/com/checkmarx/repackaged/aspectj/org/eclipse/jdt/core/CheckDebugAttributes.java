...
public final class CheckDebugAttributes extends Task {
	...
	public void execute() throws BuildException {
		...
		try {
			...
			if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(this.file)) {
				...
				for (Enumeration entries = jarFile.entries(); !hasDebugAttributes && entries.hasMoreElements(); ) {
					...
					if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(entry.getName())) {
