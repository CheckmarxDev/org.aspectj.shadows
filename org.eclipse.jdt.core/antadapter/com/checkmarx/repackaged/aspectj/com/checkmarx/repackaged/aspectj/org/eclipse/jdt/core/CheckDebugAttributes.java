...
import com.checkmarx.repackaged.aspectj.com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IClassFileReader;
import com.checkmarx.repackaged.aspectj.com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.ICodeAttribute;
import com.checkmarx.repackaged.aspectj.com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.util.IMethodInfo;
...
public final class CheckDebugAttributes extends Task {
	...
	public void execute() throws BuildException {
		...
		try {
			...
			if (com.checkmarx.repackaged.aspectj.com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(this.file)) {
				...
				for (Enumeration entries = jarFile.entries(); !hasDebugAttributes && entries.hasMoreElements(); ) {
					...
					if (com.checkmarx.repackaged.aspectj.com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(entry.getName())) {
