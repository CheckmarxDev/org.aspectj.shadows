 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IAnnotatable;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IAnnotation;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IClassFile;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IJavaElement;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IJavaModelStatusConstants;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IPackageFragment;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IPackageFragmentRoot;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.compiler.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.*;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.*;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.impl.CompilerOptions;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.impl.ITypeRequestor;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.parser.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.HashtableOfIntValues;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Messages;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.SimpleLookupTable;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.SimpleSet;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.SuffixConstants;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.hierarchy.HierarchyResolver;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.BinaryMember;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.BinaryMethod;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.BinaryType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.ClassFile;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnit;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.JarPackageFragmentRoot;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.LambdaFactory;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.Openable;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.PackageFragment;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.PackageFragmentRoot;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.SearchableEnvironment;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.SourceMapper;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.index.Index;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.ASTNodeFinder;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.HandleFactory;
...
public com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] workingCopies;
...
public static class WorkingCopyDocument extends JavaSearchDocument {
	public com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy;
	WorkingCopyDocument(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy, SearchParticipant participant) {
...
public static SearchDocument[] addWorkingCopies(SearchPattern pattern, SearchDocument[] indexMatches, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies, SearchParticipant participant) {
 ...
 */
private static HashMap workingCopiesThatCanSeeFocus(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies, SearchPattern pattern, SearchParticipant participant) {
	if (copies == null) return new HashMap();
	HashMap result = new HashMap();
	for (int i=0, length = copies.length; i<length; i++) {
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy = copies[i];
...
protected IJavaElement createHandle(LambdaExpression lambdaExpression, IJavaElement parent) {
	com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.LambdaExpression lambdaElement = LambdaFactory.createLambdaExpression((JavaElement) parent, lambdaExpression);
...
protected IJavaElement createHandle(AbstractVariableDeclaration variableDeclaration, IJavaElement parent) {
	...
	switch (variableDeclaration.getKind()) {
		...
		case AbstractVariableDeclaration.TYPE_PARAMETER:
			return new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.TypeParameter((JavaElement)parent, new String(variableDeclaration.name));
	}
	return null;
}
/**
...
public void initialize(JavaProject project, int possibleMatchSize) throws JavaModelException {
	...
	map.put(CompilerOptions.OPTION_TaskTags, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING);
...
public void locateMatches(SearchDocument[] searchDocuments) throws CoreException {
	...
	this.workingCopies = new com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[copiesLength];
	...
	try {
		...
		for (int i = 0; i < docsLength; i++) {
			...
			Openable openable;
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy = null;
