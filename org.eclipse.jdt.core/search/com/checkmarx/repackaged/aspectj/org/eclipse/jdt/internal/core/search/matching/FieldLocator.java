 ...
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.PatternLocator#updateMatch(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding, char[][][], com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.MatchLocator)
 *
 */
...
protected void reportDeclaration(FieldBinding fieldBinding, MatchLocator locator, SimpleSet knownFields) throws CoreException {
	...
	if (isBinary) {
		...
		info = locator.getBinaryInfo((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.ClassFile) type.getClassFile(), resource);
