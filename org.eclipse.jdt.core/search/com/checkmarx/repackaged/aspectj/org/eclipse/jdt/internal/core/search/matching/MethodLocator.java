...
public int match(ReferenceExpression node, MatchingNodeSet nodeSet) {
	if (!this.pattern.findReferences) return IMPOSSIBLE_MATCH;
	if (!matchesName(this.pattern.selector, node.selector)) return IMPOSSIBLE_MATCH;
	if (node.selector != null &&  Arrays.equals(node.selector, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.ConstantPool.Init))
...
/* (non-Javadoc)
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.PatternLocator#matchLevelAndReportImportRef(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ImportReference, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.Binding, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.MatchLocator)
...
/**
 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.PatternLocator#matchReportReference(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IJavaElement, Binding, int, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.MatchLocator)
 */
...
protected void reportDeclaration(MethodBinding methodBinding, MatchLocator locator, SimpleSet knownMethods) throws CoreException {
	...
	if (type.isBinary()) {
		...
		IBinaryType info = locator.getBinaryInfo((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.ClassFile)type.getClassFile(), resource);
