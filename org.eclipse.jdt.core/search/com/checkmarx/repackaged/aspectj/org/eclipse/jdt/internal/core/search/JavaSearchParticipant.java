...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.indexing.BinaryIndexer;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.indexing.SourceIndexer;
...
public class JavaSearchParticipant extends SearchParticipant {
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#beginSearching()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#doneSearching()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#getDocument(String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#indexDocument(SearchDocument)
	 */
	public void indexDocument(SearchDocument document, IPath indexPath) {
		...
		if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.Util.isJavaLikeFileName(documentPath)) {
			this.sourceIndexer = new SourceIndexer(document);
			this.sourceIndexer.indexDocument();
		} else if (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.isClassFileName(documentPath)) {
			new BinaryIndexer(document).indexDocument();
		}
	}

	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#indexResolvedDocument(SearchDocument, IPath)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#resolveDocument(SearchDocument document)
	 */
	...
	/* (non-Javadoc)
	 * @see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchParticipant#selectIndexes(com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchQuery, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchContext)
	 */
