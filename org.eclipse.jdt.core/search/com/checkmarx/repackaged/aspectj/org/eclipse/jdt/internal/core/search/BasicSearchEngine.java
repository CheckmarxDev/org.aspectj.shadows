...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.indexing.*;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.matching.*;
...
/**
 * Search basic engine. Public search engine (see {@link com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.SearchEngine}
			...
			if (copies != null) {
				for (int i = 0; i < copiesLength; i++) {
					...
					if (workingCopy.isConsistent()) {
						...
						com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit unit = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) workingCopy;
