...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.builder.ClasspathLocation;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.nd.field.FieldSearchIndex;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.nd.util.PathMap;
...
public class IndexBasedJavaSearchEnvironment implements INameEnvironment, SuffixConstants {
	...
	public IndexBasedJavaSearchEnvironment(List<IJavaProject> javaProject, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies) {
	...
	private NameEnvironmentAnswer findClassInUnindexedLocations(String qualifiedTypeName, char[] typeName) {
		...
		while (iter.hasNext()) {
			...
			if (location instanceof ClasspathSourceDirectory) {
				...
				com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit workingCopy = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.workingCopies.get(qualifiedTypeName);
				if (workingCopy != null) {
	...
	public static INameEnvironment create(List<IJavaProject> javaProjects, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies) {
