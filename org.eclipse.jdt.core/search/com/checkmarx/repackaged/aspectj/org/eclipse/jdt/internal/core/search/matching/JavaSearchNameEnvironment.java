...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IPackageDeclaration;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.builder.ClasspathJar;
...
public class JavaSearchNameEnvironment implements INameEnvironment, SuffixConstants {
	 ...
	 */
	Map<String, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit> workingCopies;

public JavaSearchNameEnvironment(IJavaProject javaProject, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies) {
	this.locationSet = computeClasspathLocations((JavaProject) javaProject);
	this.workingCopies = getWorkingCopyMap(copies);
}

public static Map<String, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit> getWorkingCopyMap(
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies) {
	int length = copies == null ? 0 : copies.length;
	HashMap<String, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit> result = new HashMap<>(length);
	try {
		if (copies != null) {
