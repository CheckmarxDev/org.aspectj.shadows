...
public MethodBinding asRawMethod(LookupEnvironment env) {
	...
	for (int i = 0; i < length; i++) {
		...
		if (var.boundsCount() <= 1) {
			...
			arguments[i] = env.createWildcard(null, 0, rawFirstBound, rawOtherBounds, com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.Wildcard.EXTENDS);
		}
	}
