 ...
 *							Bug 442416 - $deserializeLambda$ missing cases for nested lambdas
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.AnnotationContext;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.AnnotationTargetTypeConstants;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.AttributeNamesConstants;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.CodeStream;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.ConstantPool;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.ExceptionLabel;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.Opcodes;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.StackMapFrame;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.StackMapFrameCodeStream;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.StackMapFrameCodeStream.ExceptionMarker;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.StackMapFrameCodeStream.StackDepthMarker;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.StackMapFrameCodeStream.StackMarker;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.TypeAnnotationCodeStream;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.VerificationTypeInfo;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.impl.StringConstant;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.PolymorphicMethodBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.AbortMethod;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.AbortType;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.ProblemSeverities;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.ShouldNotImplement;
...
public class ClassFile implements TypeConstants, TypeIds {
	 ...
	 *
	 * @param typeDeclaration com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.TypeDeclaration
	 * @param unitResult com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.CompilationUnitResult
	 */
	 ...
	 *
	 * @param method com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration
	 * @param methodBinding com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.nameloopkup.MethodBinding
	 */
	 ...
	 *
	 * @param problems com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.problem.Problem[]
	 */
	 ...
	 *
	 * @param methodBinding com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.nameloopkup.SyntheticAccessMethodBinding
	 */
...
//						stackMapFrameCodeStream.addExceptionMarker(handlerPC, exceptionLabel.exceptionType);
	 ...
	 * - and debug attributes if necessary.
	 *
	 * @param binding com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.SyntheticAccessMethodBinding
	 * @param codeAttributeOffset <CODE>int</CODE>
	 */
...
//AspectJ end
	 ...
	 *
	 * @param methodBinding com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding
...
//				}
	 ...
	 * @return com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.codegen.ClassFile
	 */
