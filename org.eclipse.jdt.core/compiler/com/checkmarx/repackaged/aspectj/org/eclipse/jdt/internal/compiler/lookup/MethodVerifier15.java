...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Sorting;
...
boolean checkInheritedReturnTypes(MethodBinding method, MethodBinding otherMethod) {
	...
	/* We used to have some checks here to see if we would have already blamed the super type and if so avoid blaming
	   ...
	   where we do this extra reporting see com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.tests.compiler.regression.MethodVerifyTest.test159()
	 */
...
public boolean isMethodSubsignature(MethodBinding method, MethodBinding inheritedMethod) {
	if (!com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.compiler.CharOperation.equals(method.selector, inheritedMethod.selector))
		return false;
