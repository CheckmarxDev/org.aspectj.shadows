...
public boolean isBoxingCompatible(TypeBinding expressionType, TypeBinding targetType, Expression expression, Scope scope) {
	...
	return expressionType.isBaseType()  // narrowing then boxing ? Only allowed for some target types see 362279
		...
		&& scope.compilerOptions().sourceLevel >= com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.classfmt.ClassFileConstants.JDK1_5 // autoboxing
...
/** 
 * Implementation of {@link com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.InvocationSite#invocationTargetType}
