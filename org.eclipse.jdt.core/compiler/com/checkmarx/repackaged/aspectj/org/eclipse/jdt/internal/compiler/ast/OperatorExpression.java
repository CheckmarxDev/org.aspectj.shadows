...
public abstract class OperatorExpression extends Expression implements OperatorIds {
	...
	public static final String generateTableTestCase(){
		...
		/*
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.
		...
		*/
		...
		s = "\tpublic static void binaryOperationTablesTestCase(){\n" + //$NON-NLS-1$
			...
			"\t\t//com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.ast.OperatorExpression.generateTableTestCase();\n"+ //$NON-NLS-1$
