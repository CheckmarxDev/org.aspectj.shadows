...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IBuffer;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IJavaElement;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IMember;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IOpenable;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ISourceRange;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.TypeNameMatch;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.search.TypeNameMatchRequestor;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionJavadocParser;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionNodeFound;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionOnImportReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionOnPackageReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionOnQualifiedTypeReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionOnSingleTypeReference;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.select.SelectionParser;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.classfmt.ClassFileReader;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.classfmt.ClassFormatException;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MemberTypeBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.SyntheticMethodBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.ClassFile;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.SelectionRequestor;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.nd.java.model.BinaryTypeDescriptor;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.nd.java.model.BinaryTypeFactory;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.BasicSearchEngine;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.search.TypeNameMatchRequestorWrapper;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.ASTNodeFinder;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.util.HashSetOfCharArrayArray;
...
public final class SelectionEngine extends Engine implements ISearchRequestor {
	 ...
	 *
	 *  @param nameEnvironment com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.SearchableEnvironment
	 *      used to resolve type/package references and search for types/packages
	 *      based on partial names.
	 *
	 *  @param requestor com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.ISelectionRequestor
	...
	private void findAllTypes(char[] prefix) {
		try {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit[] workingCopies = this.owner == null ? null : JavaModelManager.getJavaModelManager().getWorkingCopies(this.owner, true/*add primary WCs*/);
	 ...
	 *
	 *  @param context com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.IType
	...
	public void selectType(char[] typeName, IType context) throws JavaModelException {
		try {
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit cu = context.getCompilationUnit();
			if (cu != null) {
				...
				CompilationResult result = new CompilationResult((com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) cu, 1, 1, this.compilerOptions.maxProblemsPerUnit);
