...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.codeassist.impl.AssistCompilationUnit;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.env.ITypeAnnotationWalker;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.impl.ReferenceContext;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.BinaryTypeBinding;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.core.CompilationUnitElementInfo;
...
public class InternalExtendedCompletionContext {
	...
	private void computeEnclosingJavaElements() {
		...
		if (this.typeRoot.getElementType() == IJavaElement.COMPILATION_UNIT) {
	 		ICompilationUnit original = (com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit)this.typeRoot;
			...
			com.checkmarx.repackaged.aspectj.org.eclipse.jdt.core.ICompilationUnit handle = new AssistCompilationUnit(original, this.owner, handleToBinding, handleToInfo);
