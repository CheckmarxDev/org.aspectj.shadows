...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AnnotationHolder;
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.AptBinaryLocalVariableBinding;
...
public class ExecutableElementImpl extends ElementImpl implements
	...
	public boolean overrides(ExecutableElement overridden, TypeElement type)
	{
		...
		com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.lookup.MethodBinding[] superMethods = ((ReferenceBinding)match).getMethods(selector);
