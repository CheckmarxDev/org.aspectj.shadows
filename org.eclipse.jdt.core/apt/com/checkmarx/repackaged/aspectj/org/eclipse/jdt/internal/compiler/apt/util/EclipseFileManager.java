 ...
 *******************************************************************************/
package com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.apt.util;
...
import com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.batch.Main.ResourceBundleFactory;
...
public class EclipseFileManager implements StandardJavaFileManager {
	...
	Iterable<? extends File> getDefaultBootclasspath() {
		...
		for (String fileName : com.checkmarx.repackaged.aspectj.org.eclipse.jdt.internal.compiler.util.Util.collectFilesNames()) {
